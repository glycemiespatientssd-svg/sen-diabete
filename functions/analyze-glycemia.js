      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            {
              type: "text",
              text: "ANALYSE CETTE PHOTO D'UN LECTEUR DE GLYCÉMIE et retourne UNIQUEMENT la valeur numérique en mg/dL. RÈGLES : Retourne UNIQUEMENT le nombre (ex: '112') ou 'Non lisible' si impossible"
            },
            {
              type: "image_url",
